...
export const links = [
  {
    ...
    links: [
      {
        name: 'dashboard', // ✅ Matches `<Route path='' element={<Dashboard />} />`
        path: '/dashboard',
        icon: <FiShoppingBag />,
      },
    ],
  },
  {
    ...
    links: [
      {
        name: 'applicants', // ✅ Matches `<Route path='applicants' element={<Applicants />} />`
        path: '/dashboard/applicants',
        icon: <AiOutlineShoppingCart />,
      },
      {
        name: 'centers', // ✅ Matches `<Route path='centers' element={<Centers />} />`
        path: '/dashboard/centers',
        icon: <IoMdContacts />,
      },
      {
        name: 'report', // ✅ Matches `<Route path='report' element={<Reports />} />`
        path: '/dashboard/report',
        icon: <FiPieChart />,
      },
      {
        name: 'settings', // ⚠️ Not yet included in `Routes`
